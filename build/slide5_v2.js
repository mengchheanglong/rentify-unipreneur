...
const OUT = path.join(ROOT, 'output', 'drafts', 'Rentify_slide05_proof_v2.pptx');
...
(async () => {
  ...
  const screens = [
    ...
    ['v6/r2/c-dash-after.png', 1676, 943, 'Merchant dashboard', C.teal, 'LayoutDashboard', 'Stock 39'],
  ];
  for (let i = 0; i < 3; i++) {
