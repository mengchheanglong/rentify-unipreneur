...
const OUT = path.join(ROOT, 'output', 'drafts', 'Rentify_v6_slide03_add-once.pptx');
...
(async () => {
  ...
  const screens = [
    ['v6/s4q-storefront.png', 1760, 990, 'Own storefront', C.blue, 'Globe'],
    ['v6/s4q-marketplace.png', 2160, 1215, 'Marketplace', C.orange, 'ShoppingBag'],
    ['v6/s4q-pos.png', 1760, 990, 'POS at the counter', C.teal, 'Store'],
  ];
  for (let i = 0; i < 3; i++) {
