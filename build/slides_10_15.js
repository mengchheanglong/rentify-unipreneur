...
(async () => {
  // ================= Appendix slide 14: How we grow =================
  {
    ...
    const steps = [
      ...
      ['YEAR 3', '~$420', 'per founder / month', 'Target', 'Paid from profit; $18.6K kept'],
    ];
...
Here is our growth plan. We start now with ten pilot shops in Phnom Penh, found through shop visits and Facebook seller groups. In 2027 we launch publicly with KHQR payments and reach about 60 paying shops. In year two, shops bring their own buyers through their storefront links and we grow to about 420. In year three, referrals and partners take us to about 1,100. About 110 paying shops cover our running costs, so we pay for ourselves from Year 1; the team works unpaid that year and is then paid from profit, about 420 dollars a month each by Year 3.
