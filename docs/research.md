...
## Bootstrapped cost assumptions (model v4)

The model follows how a small self-funded team works. All 5 founders do product, sales, onboarding and support themselves, and there are no hires in Years 1–3. The team is unpaid in Year 1. From Year 2 it takes half of each year's profit, up to US$500 per founder a month, and keeps the rest in the company. Marketing is 10% of revenue plus referral credits. There is no office rent (home, university or free startup space), the team shares a few AI subscriptions, and an accountant is hired only from Year 3.

Checked 25 September 2026:
- **Founder pay:** bootstrapped founders often start at $0 and pay themselves little for years. In one survey, a bootstrapped founder "didn't pay themselves more than 1k/month for a few years". [Pilot founder salary report](https://pilot.com/founder-salary-report-2024), [Practical Founders](https://practicalfounders.com/articles/startup-founders-usually-dont-make-a-real-salary-at-first/), [Hacker News survey thread](https://news.ycombinator.com/item?id=33236283)
- **Marketing spend:** early bootstrapped SaaS companies often spend 20–40% of revenue on marketing, and equity-backed companies spend far more. Rentify's 10% is lower because growth is founder-led (shop visits, Facebook groups, referrals). If growth is slower than the team model assumes, marketing may need to rise. [SaaS Capital spending benchmarks](https://www.saas-capital.com/blog-posts/spending-benchmarks-for-private-b2b-saas-companies/), [SaaS Hero bootstrapped budget framework](https://www.saashero.net/strategy/bootstrapped-saas-marketing-budget-framework/)
- **Free workspace:** Techo Startup Center, under the Ministry of Economy and Finance, offers free or subsidised workspace to startups in Phnom Penh. [Startup Cambodia](https://startupcambodia.gov.kh/ecosystem/discover/category/eso/7)
- **Caveat:** "profit" here counts the founders' work at $0, so it is not what the business would earn with a paid team. If all 5 were paid a market salary, Rentify would need about 1,400 paying shops at Year 3 costs to break even. The model's "shops needed to pay every founder $500/month" (about 765) is the more honest milestone.
