...
- **Caveat:** "profit" here counts the founders' work at $0, so it is not what the business would earn with a paid team. If all 5 were paid a market salary, Rentify would need roughly 1,700+ paying shops to break even. The model's "shops needed to pay every founder $500/month" (about 765) is the more honest milestone.
